...
\begin{figure}
	\centering
	%\includegraphics[width=0.7\linewidth]{} %TODO insert image of Label Studio
...
output files of the training run are saved. Additionally the image size is set to 384 pixels because of 
...
to train the backbone on a large-scale image classification task such as the COCO dataset. 

%TODO freeze Command lässt backbone zb weg 
%TODO cite y5TransfLearn
