...
%TODO describe conf-thres + IoU-tresh + save-crop only recommended for images because it 
%saves an image of all bounding boxes and their content and for videos that are realy much frames
