...
\newcommand{\titel}{Analysis of gameplay from the video game Valorant using the framework 
YOLOv5} 
\newcommand{\jahr}{2023}
...
\input{chapters/anhang/acronyms}

% Trennungsregeln
\hyphenation{Hy-phe-na-tion}

\begin{document}
\include{chapters/00-titel}
...
\appendix
\input{chapters/anhang/applicationAdditions}
\input{chapters/anhang/evaluationAdditions}
